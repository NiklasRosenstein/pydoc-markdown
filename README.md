...
[>> Go to the Documentation](https://niklasrosenstein.github.io/pydoc-markdown/)
...
* MkDocs integration
* [Read the Docs](https://readthedocs.org) support
...
__Deploying to Read the Docs__

The `pydoc-markdown-readthedocs-mkdocs-proxy` installs some changes to the Read the Docs build
environment that will dispatch it's call to `python -m mkdocs build` to Pydoc-Markdown instead.
You can bootstrap a `.readthedocs.yml` using the below command:
